...
CREATE TABLE order_detail (
	...
	INSERT INTO product (name,image_path,quantity,description,price,is_delete,supplier_id) VALUES
	 (N'Coca',N'/images/coca.jpg',151,N'Refreshing Coca Cole',1.99,1,1),
	 (N'Snack - new',N'/images/snack.jpg',10,N'Delicious Snack',3.0,0,1),
	 (N'Chips',N'/images/chips.jpg',87,N'Crunchy Potato Chips',4.0,0,1),
	 (N'Soda',N'/images/soda.jpg',1,N'Fizzy Soda',0.99,0,1),
	 (N'Chocolate',N'/images/chocolate.jpg',1,N'Smooth Milk Chocolate',4.99,0,1),
	 (N'Cookies',N'/images/cookies.jpg',150,N'Homemade Cookies',2.99,0,1),
	 (N'Juice',N'/images/juice.jpg',178,N'Fresh Fruit Juice',1.49,0,1),
	 (N'Water',N'/images/water.jpg',250,N'Bottled Water',0.75,0,1),
	 (N'Popcorn',N'/images/popcorn.jpg',120,N'Buttered Popcorn',2.29,0,1),
	 (N'Energy Drink',N'/images/energy.jpg',100,N'High-Energy Drink',3.49,0,1);
	
	INSERT INTO product (name,image_path,quantity,description,price,is_delete,supplier_id) VALUES
	 (N'Pepsi',N'uri/123',1233,N'Here is drink',123.0,0,1),
	 (N'asd',N'asd',123,N'asd',123.0,0,1),
	 (N'Snack',N'/images/snack.jpg',200,N'Delicious Snack',2.49,0,1),
	 (N'Coca',N'/images/coca.jpg',150,N'Refreshing Coca Cola',1.99,0,1),
	 (N'Coca',N'/images/coca.jpg',150,N'Refreshing Coca Cola',1.99,0,1),
	 (N'Coca',N'/images/coca.jpg',150,N'Refreshing Coca Cole',1.99,0,1),
	 (N'Coca',N'/images/coca.jpg',150,N'Refreshing Coca Cole',1.99,0,1),
	 (N'new product',N'urk/image',1,N'this is new product',1.0,1,3),
	 (N'bi dao',N'uri/image',100,N'good drink',1.0,0,1),
	 (N'coca',N'uri/uamge',10,N'have co2',2.0,0,1);
